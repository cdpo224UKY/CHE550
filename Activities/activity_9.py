...
if __name__ == '__main__':
    ...
    membrane_pro_list = CHE550_tools.ut.uniprot_txt_parser(membrane_pro_str)
    ...
    helix_pro_list = CHE550_tools.ut.uniprot_txt_parser(helix_pro_str)
    ...
    sheet_pro_list = CHE550_tools.ut.uniprot_txt_parser(sheet_pro_str)
